...
# This is stored as a JS object on window.CONFIG in the front-end.
BUNDLE_CONFIG = {
    'SERVICE_ROOT': f'{SERVICE_ROOT}/nwis',
    'PAST_SERVICE_ROOT': f'{PAST_SERVICE_ROOT}/nwis',
    'HYDRO_ENDPOINT': HYDRO_ENDPOINT,
    'FIM_GIS_ENDPOINT': FIM_GIS_ENDPOINT,
