...
// Since the audible interface is likely to change and testing requires considerable mocking,
// disabling the tests for now.
xdescribe('monitoring-location/components/hydrograph/audible audibleUI', () => {
    config.TIMESERIES_AUDIO_ENABLED = true;
    let container;
    let store;
    beforeEach(() => {
